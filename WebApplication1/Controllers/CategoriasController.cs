...
namespace Ejercicio5.Controllers
{
    ...
    {
        private readonly Ejercicio5Context _context;

        public CategoriasController(Ejercicio5Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string sortOrder, string currentFilter, string searchString, int? page)
        {
            ...
            var categorias = form s in _context.Categoria select s;

            if (!String.IsNullOrEmpty(searchString))
            {
                categorias = categorias.Where(s => s.Nombre.Contains(searchString) || s.Desxripcion.Contains(searchString));
            }
            /*
             * from <Nombre-la-variable-que-almacenara-un-elemento-a la-ves-de-la-coleccion>
             * in <fuente-de-datos>
